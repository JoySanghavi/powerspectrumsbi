...
class createxfromnvandnoisenv:
    ...
    def simulate_batch(self, batch_size, normed_tracked_uv, noisenormed_tracked_uv):
        normed_tracked_uv = torch.tensor(normed_tracked_uv)
        noisenormed_tracked_uv = torch.tensor(noisenormed_tracked_uv)
